...
#include "DHTesp.h" // dht sensor by beegee_tokyo
...
const char* ssid = "WiFye2.0";
const char* password = "natalie20";

/******* MQTT Broker Connection Details *******/
const char* mqtt_server = "6b761dbf033d4a2dba5d4912075d5be0.s2.eu.hivemq.cloud";
const char* mqtt_username = "SmartDewMQTTReader";
const char* mqtt_password = "0dKLMR261APL";
